  ...
  <body>
    ...
    <script>
      ...
      function renderAllianceBoard(events = []) {
        ...
        const notes = [["/calendar", "events.png", "Events"], ["/wiki", "embed-sender.png", "Wiki"], ["/members", "members.png", "Members"], ["/attendance", "events.png", "Attendance"], ["/research", "lord-tools.svg", "Research"], ["/training-tools", "training-tools.png", "Training"], ["/migration", "/assets/migration-gold.png", "Migration"]];
