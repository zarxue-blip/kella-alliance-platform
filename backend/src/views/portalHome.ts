...
export const portalHomeClient = String.raw`
      function renderAllianceBoard(events = []) {
        ...
        const baseBuildings = ['alliance-hub','archery-range','elk-stable','ranger-sentry-post','longleaf-arch','notice-board','research','eagle-nest'];
        const basePreview = '<section class="portal-base-section" aria-labelledby="portal-base-title"><div class="portal-section-heading"><div><p class="portal-eyebrow">YOUR LIVING SETTLEMENT</p><h2 id="portal-base-title">Alliance Base</h2></div><span>Animated and ready to arrange.</span></div><a class="portal-base-entry" href="/base" aria-label="Enter alliance base building mode"><img class="portal-base-map" src="/assets/base-game/assets/map.png" alt="EVO alliance base" loading="lazy"/>'+baseBuildings.map(function(file,index){return '<img class="portal-base-building portal-base-building-'+index+'" src="/assets/base-game/assets/'+file+'.png" alt="" loading="lazy"/>';}).join('')+'<span class="portal-base-vignette"></span><strong>Enter building mode <b>↗</b></strong></a></section>';
